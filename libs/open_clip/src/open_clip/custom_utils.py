...
# https://github.com/pytorch/pytorch/blob/main/torch/nn/functional.py#L5178
def multi_head_attention_forward(
    ...
    if need_weights:
        ...
        attn_output_weights = F.sigmoid(attn_output_weights) / num_heads
        if dropout_p > 0.0:
        ...
        raise RuntimeError('Only support need weights to prevent use softmax')

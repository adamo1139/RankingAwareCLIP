...
_VITB16 = _VITB16_adapter = _VITB16_PLUS_adapter = dict(
    openai=_pcfg(
...
_VITL14_336 = _VITL14_336_adapter = dict(
    openai=_pcfg(
...
_convnext_base = _convnext_base_adapter = dict(
...
_convnext_base_w_320 = _convnext_base_w_320_adapter = _convnext_base_w_224_adapter = dict(
...
_convnext_large_d = _convnext_large_d_adapter = dict(
    laion2b_s26b_b102k_augreg=_pcfg(hf_hub='laion/CLIP-convnext_large_d.laion2B-s26B-b102K-augreg/'),
)

_convnext_large_d_320 = _convnext_large_d_320_rankdr = _convnext_large_d_320_adapter = dict(
...
_PRETRAINED = {
    "RN50": _RN50,
    "RN50-adapter": _RN50_adapter,
    "RN50-quickgelu": _RN50_quickgelu,
    "RN101": _RN101,
    "RN101-adapter": _RN101_adapter,
    "RN101-quickgelu": _RN101_quickgelu,
    "RN50x4": _RN50x4,
    "RN50x16": _RN50x16,
    "RN50x64": _RN50x64,
    "RN50x64-adapter": _RN50x64,

    "ViT-B-32": _VITB32,
    "ViT-B-32-adapter": _VITB32_adapter,
    "ViT-B-32-256": _VITB32_256,
    "ViT-B-32-quickgelu": _VITB32_quickgelu,
    "ViT-B-16": _VITB16,
    "ViT-B-16-adapter": _VITB16_adapter,
    "ViT-B-16-plus-adapter": _VITB16_PLUS_adapter,
    "ViT-B-16-quickgelu": _VITB16_quickgelu,
    "ViT-B-16-plus-240": _VITB16_PLUS_240,
    "ViT-L-14": _VITL14,
    "ViT-L-14-adapter": _VITL14_adapter,
    "ViT-L-14-quickgelu": _VITL14_quickgelu,
    "ViT-L-14-336": _VITL14_336,
    "ViT-L-14-336-adapter": _VITL14_336_adapter,
    "ViT-H-14": _VITH14,
    ...
    "convnext_base-adapter": _convnext_base_adapter,
    "convnext_base_w": _convnext_base_w,
    "convnext_base_w_320": _convnext_base_w_320,
    "convnext_base_w_320-adapter": _convnext_base_w_320_adapter,
    "convnext_base_w_224-adapter": _convnext_base_w_224_adapter,
    "convnext_large_d": _convnext_large_d,
    "convnext_large_d_320": _convnext_large_d_320,
    "convnext_xxlarge": _convnext_xxlarge,
    "convnext_large_d-adapter": _convnext_large_d_adapter,
    "convnext_large_d_320_rankdr": _convnext_large_d_320_rankdr,
    "convnext_large_d_320-adapter": _convnext_large_d_320_adapter,

    "coca_ViT-B-32": _coca_VITB32,
    "coca_ViT-L-14": _coca_VITL14,
    "coca_ViT-B-32-adapter": _coca_VITB32_adapter,
    "coca_ViT-B-32-adapter-exp": _coca_VITB32_adapter,
